...
public record CatalogVariantResponse(
  @Schema(description = "Id de la variante", example = "101")
  Long id,
  @Schema(description = "Nombre de la variante", example = "Docena")
  String name,
  @Schema(description = "Precio vigente de la variante")
  MoneyResponse price,
  @Schema(description = "Indica si la variante maneja stock real", example = "true")
  boolean managesStock,
  @Schema(description = "Cantidad disponible si maneja stock", example = "12")
  int stockQuantity,
  @Schema(
