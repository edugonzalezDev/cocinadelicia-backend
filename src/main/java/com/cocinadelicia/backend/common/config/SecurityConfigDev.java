...
/**
 * Cadena exclusiva para H2 en DEV.
 * Deja pasar /h2-console/** y no interfiere con la cadena principal JWT.
 */
@Configuration
@Profile("dev")
class SecurityConfigDev {
    ...
    SecurityFilterChain h2ConsoleSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                .securityMatcher(PathRequest.toH2Console()) // solo aplica a /h2-console/**
