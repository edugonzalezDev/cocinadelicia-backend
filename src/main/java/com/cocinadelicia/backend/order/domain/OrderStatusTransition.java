...
/**
 * Máquina de estados para transiciones de OrderStatus.
 * Define qué transiciones son válidas y para qué roles.
 */
@Log4j2
public class OrderStatusTransition {
  ...
  private static final Map<OrderStatus, Set<OrderStatus>> ALLOWED_TRANSITIONS =
      Map.of(
          ...
          OrderStatus.READY, EnumSet.of(OrderStatus.OUT_FOR_DELIVERY, OrderStatus.DELIVERED, OrderStatus.CANCELLED),
