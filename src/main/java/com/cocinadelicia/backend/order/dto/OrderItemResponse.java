...
public record OrderItemResponse(
  ...
  @Schema(description = "Id interno del ítem de pedido", example = "101")
  Long id,
  ...
  @Schema(description = "Nombre del producto", example = "Pizza Muzarella")
  String productName,

  @Schema(description = "Nombre de la variante", example = "Grande")
  String variantName,
