...
public record ShippingAddressRequest(
    ...
    @Schema(description = "Región / Departamento", example = "Canelones") @Size(max = 100) String region,
    @Schema(description = "Código postal", example = "15000") @Size(max = 20) String postalCode,
