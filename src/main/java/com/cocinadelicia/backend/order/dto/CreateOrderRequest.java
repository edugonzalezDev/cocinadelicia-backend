...
public record CreateOrderRequest(
    ...
    @Schema(
        ...
        // Podrías agregar @FutureOrPresent si más adelante quieres validar que no sea pasado
        Instant requestedAt,

    // Solo requerido si fulfillment == DELIVERY (se valida en el servicio)
    @Schema(description = "Datos de envío, requeridos cuando fulfillment = DELIVERY") @Valid ShippingAddressRequest shipping) {}
