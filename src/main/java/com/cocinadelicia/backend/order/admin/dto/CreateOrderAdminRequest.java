...
public record CreateOrderAdminRequest(
    ...
    @Schema(description = "Datos de envío (requerido si fulfillment=DELIVERY)") @Valid ShippingAddressRequest shipping,
    @Schema(
    ...
    @Schema(description = "Email del chef asignado (opcional)", example = "chef@example.com")
        @Email(message = "Debe ser un email válido") String assignedChefEmail) {}
